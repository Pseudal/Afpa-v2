          ...
          <Card style={{ width: "18rem" }}>
              ...
              <Card.Title>Modifier un produit</Card.Title>
                  <form onSubmit={handleSubmit}>
                      ...
                      <div className="">
                          <input className="form-check-input m-1" type="checkbox" name="avaible" id="avaible" name="avaible" placeholder="disponible ?" onChange={handleChange} defaultValue={Produit.avaible} />
