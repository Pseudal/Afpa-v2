          ...
          <tbody>
            {products && products.map(product => (
              <tr key={product.id}>
                 ...
                 <td><Button variant="danger" onClick={() => {del(product.id)}}>Delete</Button><Link className="btn btn-warning " state={{ Produit: product, id:product.id}} to={`/ModifProduct`}>Modif</Link></td> 
              </tr>
            ))}
          </tbody>
        </Table>
